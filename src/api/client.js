...
// Fetches a file endpoint (authenticated) and triggers a browser download.
...
export const api = {
  ...
  undoClockOut: () => request('/api/clock/undo', { method: 'POST' }),
  ...
  activateStaff: (id) => request(`/api/staff/${id}/activate`, { method: 'POST' }),
